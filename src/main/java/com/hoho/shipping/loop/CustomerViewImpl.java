...
import com.hoho.shipping.parcel.ParcelView;
import com.hoho.shipping.parcel.parcelElement.Parcel;
import com.hoho.shipping.util.SimpleInput;
...
public class CustomerViewImpl {
    ...
    public CustomerViewImpl(CustomerController customerController, ParcelRepository repository) {
