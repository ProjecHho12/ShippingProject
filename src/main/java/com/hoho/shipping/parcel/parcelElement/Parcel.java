...
public class Parcel implements Serializable {
    ...
    public String toString() {
        return String.format("운송장번호: %s\n보내는 분\n%s\n받는 분\n%s\n상품정보\n%s\n택배상태: %s | 접수일: %s",
            this.trackingNumber, this.sender, this.recipient, this.productInfo, this.status, this.regDate );
    }
...
//
//        // 택배 1개 생성
//        Parcel oneParcel = new Parcel(TrackingNumber, Sender, Recipient, productInfo, main.parcel.parcelElement.Status.INCOMING, "3000원");
//
//        return oneParcel;
//    }
