...
import com.hoho.shipping.parcel.parcelElement.ProductInfo;
import com.hoho.shipping.parcel.parcelElement.Recipient;
import com.hoho.shipping.parcel.parcelElement.Sender;
import com.hoho.shipping.parcel.parcelElement.Status;
import com.hoho.shipping.customer.Customer;
...
//        this.main.parcel.setSender(sender);
//        this.main.parcel.setRecipient(recipient);
        ...
        //parcels.add(this.main.parcel);

        // 오류System.out.println(main.parcel.toString());
...
//
//        System.out.println("파일에서 읽어온 택배 리스트:");
//        for (Parcel main.parcel : repository.getParcelArrayList()) {
//            System.out.println("접수일자   : " + main.parcel.getRegDate());
//            System.out.println("운송장번호 : " + main.parcel.getTrackingNumber());
//            System.out.println("main.parcel.getSender()");
//            System.out.println("main.parcel.getRecipient()");
//            System.out.println("상품 정보  : " + main.parcel.getProductInfo());
//            System.out.println("택배 상태  : " + main.parcel.getStatus());
//        }
//        for (Parcel main.parcel : repository.getParcelArrayList()) {
//            System.out.println(main.parcel);
//        }
//        if (repository.getParcelArrayList() == null || repository.getParcelArrayList().isEmpty()) {
