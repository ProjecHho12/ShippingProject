...
public enum TrackingNumber {
    // 운송장 번호 열거형
    SEOUL("002", Arrays.asList("SEOUL", "서울")),
    INCHON("032", Arrays.asList("INCHON", "인천")),
    DAEJEON("042", Arrays.asList("DAEJEON", "대전")),
    BUSAN("051", Arrays.asList("BUSAN", "부산")),
    ULSAN("052", Arrays.asList("ULSAN", "울산")),
    DAEGU("053", Arrays.asList("DAEGU", "대구")),
    GWANGJU("062", Arrays.asList("GWANGJU", "광주")),
